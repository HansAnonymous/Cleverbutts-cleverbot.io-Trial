...
var botapis = config.cleverbotAPI;
...
function ready() {
  for (var ii = 0; ii < DBots.length; ii++) {
    CBots[ii].configure({botapi: botapis});  
  }
...
var i = 0, callback = function callback(resp) {
  setTimeout(function (str1, str2) {
    ...
    if(lastMessages.length < 5) {
         lastMessages.push( function (response) { return response.output });
    }
    if(lastMessages.length >= 5) {
